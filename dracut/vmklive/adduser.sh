...
# Setup default root/user password (coconut).
chroot ${NEWROOT} sh -c 'echo "root:coconut" | chpasswd -c SHA512'
chroot ${NEWROOT} sh -c "echo "$USERNAME:coconut" | chpasswd -c SHA512"
